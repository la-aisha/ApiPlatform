 ...
 */
final class Version20220810234319 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE category_id categorie_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE categorie_id category_id INT NOT NULL');
