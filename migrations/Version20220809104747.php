 ...
 */
final class Version20220809104747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD category_id INT NOT NULL, DROP categorie_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD categorie_id INT DEFAULT NULL, DROP category_id');
